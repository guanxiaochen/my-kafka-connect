...
public class PhoenixJdbcSourceTaskTest {
  ...
  protected Map<String, String> getProps() {
    ...
    props.put(JdbcSourceConnectorConfig.CONNECTION_URL_CONFIG, "jdbc:phoenix:thin:url=http://tm-cdh-04:8765;serialization=PROTOBUF");
    props.put(JdbcSourceConnectorConfig.CONNECTION_USER_CONFIG, "root");
    props.put(JdbcSourceConnectorConfig.CONNECTION_PASSWORD_CONFIG, "");
    props.put(JdbcSourceConnectorConfig.CONNECTION_PREFIX+"schema", "guan_test");

    props.put(JdbcSourceConnectorConfig.MODE_CONFIG, JdbcSourceConnectorConfig.MODE_BULK);
    props.put(JdbcSourceConnectorConfig.TOPIC_PREFIX_CONFIG, "guan_java_");

    String tableName = "GUAN_TEST.TEST_PRESTO_CONNECTOR";
